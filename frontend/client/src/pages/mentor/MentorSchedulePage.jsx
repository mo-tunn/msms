...
import { getMentorStudents, getTasks, createTask, updateTask, deleteTask } from '../../services/api';
...
const MentorSchedulePage = () => {
    ...
    // Fetch tasks when selectedStudent changes
    const fetchStudentTasks = async () => {
        if (!selectedStudent) return;
        setIsLoading(true);
        try {
            const data = await getTasks(selectedStudent);
            ...
            const formattedTasks = data.map(task => {
                ...
                return {
                    ...
                    creator: task.mentor_id ? 'Mentor' : 'Öğrenci',
