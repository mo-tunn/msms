                        ...
                        <div className="flex flex-1 justify-end items-center gap-4">
                            ...
                            >
                                ...
                                <div className="text-left hidden sm:block">
                                    <p className="text-sm font-semibold text-[#111418] dark:text-white leading-tight">Dr. Selin Yılmaz</p>
                                    <p className="text-xs text-[#617589] dark:text-gray-400 leading-tight">Matematik Mentoru</p>
                                </div>
                            </div>
                        </div>
                    </header>
